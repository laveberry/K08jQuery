...
public class NaverSearchAPI extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	  ...
	  String clientId = "qic1dYUtPb8XRirTR1BY"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "RhmpXre8aJ"; //애플리케이션 클라이언트 시크릿값"

        String text = null;
        //try안에 있으면 지역변수라서 전역변수로 선언
        int startNum = 0;
        ...
        //서블릿에서 리퀘스트영역에 저장을하고 jsp로 포워드를 보통 함. 여기는 서블릿에서 직접출력
